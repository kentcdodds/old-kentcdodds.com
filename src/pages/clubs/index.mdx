...
> NOTE: You might be able to use a schedule template from the
> [📍 KCD Learning Clubs Curriculum Ideas and Templates](https://github.com/kentcdodds/kcd-learning-clubs-ideas)
> repo.
...
3. The bot will add your club to the `#📝-active-clubs` channel.
