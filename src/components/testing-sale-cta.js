...
export default function TestingSaleCta({
  title = `Your Essential Guide to Flawless Testing <div>— Now on Sale</div>`,
  button = `Get Testing JS for 40% off`,
  byline = `For Limited Time Only`,
  background = '#fafafa',
}) {
  return (
    <Banner
      ...
      <Box>
        ...
        <svg 
          css={css({
            ...
            animation: `${sparkleAnimation2} 4s linear 2s infinite`,
          })}
          xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50"><g fill="none" fillRule="evenodd"><polygon fill="#F9F9F9" points="25.084 0 27.441 20.707 37.373 12.627 29.461 22.727 50 25.084 29.461 27.441 37.373 37.373 27.441 29.461 25.084 50 22.727 29.461 12.627 37.373 20.707 27.441 0 25.084 20.707 22.727 12.627 12.627 22.727 20.707"/></g>
        </svg>
        {/* prettier-ignore */}
        <svg 
          css={css({
            ...
            position: 'absolute',
            transformOrigin: 'center center',
            animation: `${sparkleAnimation} 4s linear 0.5s infinite`,
          })}
          xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50"><g fill="none" fillRule="evenodd"><polygon fill="#F9F9F9" points="25.084 0 27.441 20.707 37.373 12.627 29.461 22.727 50 25.084 29.461 27.441 37.373 37.373 27.441 29.461 25.084 50 22.727 29.461 12.627 37.373 20.707 27.441 0 25.084 20.707 22.727 12.627 12.627 22.727 20.707"/></g>
        </svg>
