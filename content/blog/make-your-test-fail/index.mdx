---
slug: 'make-your-test-fail'
title: 'Make Your Test Fail'
date: '2020-02-24'
author: 'Kent C. Dodds'
description:
  "_If you're not careful you can write a test that's worse than having not
  tests at all_"
categories:
  - 'testing'
keywords:
...
**[Watch "Use JavaScript Modules in the browser" on egghead.io](https://egghead.io/lessons/jest-make-your-test-fail?pl=kent-s-blog-posts-as-screencasts-eefa540c)**
