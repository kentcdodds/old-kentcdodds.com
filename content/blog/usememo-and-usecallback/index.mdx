...
I'm going to make a change to this and I want you to tell me
...
In this specific case, which of these is better for
...
Yeah, they're _exactly_ the same except that the `useCallback` version is doing
...
I'm not going to go too deep into this but when you define an
...
> The following code is a bit contrived. Just focus on the concepts.
