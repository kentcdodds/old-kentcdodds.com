...
keywords:
  ...
  - testing
  - mocking
bannerUrl: https://res.cloudinary.com/kentcdodds-com/image/upload/v1625032579/kentcdodds.com/content/blog/but-really-what-is-a-javascript-mock/banner.jpg
bannerCredit:
...
> [`require.requireActual`](https://jestjs.io/docs/en/jest-object#jestrequireactualmodulename) >
> _API._
