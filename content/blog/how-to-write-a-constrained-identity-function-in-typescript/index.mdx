---
slug: 'how-to-write-a-constrained-identity-function-in-typescript'
...
keywords:
  ...
  - 'react'
  - 'testing'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625032897/kentcdodds.com/content/blog/how-to-write-a-constrained-identity-function-in-typescript/banner.jpg'
...
```tsx
const constrain = <Given extends unknown>() => <Inferred extends Given>(
  item: Inferred,
) => item
