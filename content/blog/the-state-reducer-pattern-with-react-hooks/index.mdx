...
keywords:
  - 'react'
  - 'hooks'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625033426/kentcdodds.com/content/blog/the-state-reducer-pattern-with-react-hooks/banner.jpg'
bannerCredit:
