...
author: 'Kent C. Dodds'
description:
  "_Why you should stop using client-side route redirects (like the from prop on
  React Router's Redirect component) and what you should do instead._"
categories:
  - 'react'
keywords:
  - 'javascript'
...
just downloaded and ran a bunch of code they didn't need.
