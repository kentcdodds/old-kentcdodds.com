---
slug: 'stop-using-client-side-route-redirects'
title: 'Stop using client-side route redirects'
date: '2020-04-13'
author: 'Kent C. Dodds'
description:
  "_Why you should stop using client-side route redirects (like the `from` prop
  on React Router's Redirect component) and what you should do instead._"
categories:
  - 'react'
keywords:
  - 'javascript'
  ...
  - 'netlify'
  - 'server'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625033359/kentcdodds.com/content/blog/stop-using-client-side-route-redirects/banner.jpg'
bannerCredit:
  'Photo by [Lance Grandahl](https://unsplash.com/photos/hF6TtT-xz80)'
---
