---
slug: 'react-production-performance-monitoring'
title: 'React Production Performance Monitoring'
date: '2020-03-16'
author: 'Kent C. Dodds'
description:
  '_How to set up performance monitoring for production React applications._'
categories:
  - 'react'
keywords:
  - 'performance'
  ...
  - 'monitoring'
  - 'react'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625033295/kentcdodds.com/content/blog/react-production-performance-monitoring/banner.jpg'
...
> Learn more about how to enable the profiler build from
