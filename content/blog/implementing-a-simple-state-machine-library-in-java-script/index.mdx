---
slug: 'implementing-a-simple-state-machine-library-in-java-script'
title: 'Implementing a simple state machine library in JavaScript'
date: '2020-01-20'
author: 'Kent C. Dodds'
description:
  "_Let's write a state machine abstraction together to understand it better_"
categories:
  - 'state'
keywords:
  - 'javascript'
...
https://egghead.io/lessons/javascript-implement-a-simple-finite-state-machine-library-in-javascript?pl=kent-s-blog-posts-as-screencasts-eefa540c&af=5236ad
...
Excellent. We've flushed out the API for the state definition object. Now let's
