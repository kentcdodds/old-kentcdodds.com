...
keywords:
  ...
  - 'ecmascript'
  - 'modules'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625033381/kentcdodds.com/content/blog/super-simple-start-to-es-modules-in-the-browser/banner.jpg'
bannerCredit:
...
- [Português (do Brasil)](https://mjfneto.medium.com/uma-introdu%C3%A7%C3%A3o-super-simples-aos-es-modules-no-browser-39fda8aa0da3)
