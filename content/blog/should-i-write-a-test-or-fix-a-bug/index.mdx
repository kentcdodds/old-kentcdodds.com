---
slug: 'should-i-write-a-test-or-fix-a-bug'
title: 'Should I write a test or fix a bug?'
date: '2020-06-15'
author: 'Kent C. Dodds'
description: '_How to prioritize tests relative to everything else._'
categories:
  - 'testing'
keywords:
  ...
  - 'practically testing'
  - 'practical testing'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625033332/kentcdodds.com/content/blog/should-i-write-a-test-or-fix-a-bug/banner.jpg'
bannerCredit:
