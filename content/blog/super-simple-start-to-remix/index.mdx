...
date: '2021-05-03'
author: 'Kent C. Dodds'
description: '_The simplest distraction-free version of a remix app_'
categories:
  - 'react'
keywords:
  - 'react'
  ...
  - 'remix.run'
  - 'full stack'
bannerUrl: https://res.cloudinary.com/kentcdodds-com/image/upload/v1620156193/kentcdodds.com/blog/super-simple-start-to-remix/banner_kbjpf9.jpg
...
`npm init remix` thing you can run (which is much easier that what I'm going to
...
![Network tab showing two GET requests, one for the document and the other for a favicon](https://res.cloudinary.com/kentcdodds-com/image/upload/v1620151937/kentcdodds.com/blog/super-simple-start-to-remix/network-tab_t1rhwr.png)
