...
[![Chart calculating whether something is worth the time to automate](./images/is_it_worth_the_time.png)](https://xkcd.com/1205/)

[![Graph showing that you spend forever automating a task](./images/automation.png)](https://xkcd.com/1319/)
...
With that in mind, here are the minimum number of steps I need to take when I
...
P.S. You can
[check out my blog post automation script here](https://github.com/kentcdodds/kentcdodds.com/blob/master/generate/blogpost.js).
