...
That's pretty much it for me. If I'm just doing some exploratory coding (which I
do a lot) or messing around then I won't bother following TDD and I'll only add
tests when I'm pleased with the direction things have taken. Incidentally, this
is the same approach I follow any time I've used a type system (like Flow or
TypeScript). This is also the approach I follow with
[making abstractions](/blog/aha-programming).
