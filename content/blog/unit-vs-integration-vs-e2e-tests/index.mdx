...
import {render, generate, screen} from 'til-client-test-utils'
...
test('login as an existing user', async () => {
  ...
  userEvent.type(screen.getByLabelText(/username/i), fakeUser.username)
  userEvent.type(screen.getByLabelText(/password/i), fakeUser.password)
