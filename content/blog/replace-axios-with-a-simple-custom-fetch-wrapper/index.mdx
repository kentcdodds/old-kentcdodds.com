...
keywords:
  ...
  - 'dom'
  - 'browsers'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625033317/kentcdodds.com/content/blog/replace-axios-with-a-simple-custom-fetch-wrapper/banner.jpg'
bannerCredit:
