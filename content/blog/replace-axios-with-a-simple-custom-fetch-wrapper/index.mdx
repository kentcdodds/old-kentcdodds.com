...
author: 'Kent C. Dodds'
description:
  "_Axios can do a ton of stuff, but here's a simpler solution that can handle
  most use cases_"
categories:
  - 'javascript'
keywords:
...
bannerCredit:
  'Photo by [K. Mitch Hodge](https://unsplash.com/photos/kqPlrOrir5g)'
---
...
[`axios`](https://greekmythology.wikia.org/wiki/Axios) is a brilliant work and
functioned both in NodeJS and the Browser which I remember him being really
excited about (and I was too).
...
So basically if we have a toke in `localStorage` by that key, then we add the
