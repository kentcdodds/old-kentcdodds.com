...
keywords:
  ...
  - 'react hooks'
  - 'react context'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625032869/kentcdodds.com/content/blog/how-to-optimize-your-context-value/banner.jpg'
bannerCredit:
...
```javascript
function useCount() {
  return [useCount(), useCountDispatch()]
}
```
