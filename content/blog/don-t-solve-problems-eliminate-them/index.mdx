---
slug: 'don-t-solve-problems-eliminate-them'
title: "Don't Solve Problems, Eliminate Them"
date: '2021-05-11'
author: 'Kent C. Dodds'
description:
  '_How eliminating problems can drastically simplify your codebases and life_'
categories:
  - 'productivity'
keywords:
  - 'react'
  ...
  - 'tesla'
  - 'life'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1620771700/kentcdodds.com/blog/don-t-solve-problems-eliminate-them/banner_qzwcgj.jpg'
...
will blow or that I'll need new break pads, etc etc etc. (EVs require very
little maintenance because there are just so fewer parts that can wear out and
break).
...
complex client-side graphql client with Remix to avoid over fetching).
