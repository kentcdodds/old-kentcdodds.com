...
author: 'Kent C. Dodds'
description:
  '_Why using a status enum (or even better: a **state machine**) will help your
  app stay bug free_'
categories:
  - 'javascript'
keywords:
  ...
  - 'isResolved'
  - 'isIdle'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625033365/kentcdodds.com/content/blog/stop-using-isloading-booleans/banner.jpg'
bannerCredit:
