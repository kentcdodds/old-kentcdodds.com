...
3. Bring in [recoil](https://recoiljs.org/)
...
not well stuited. Of all the available abstractions, recoil is the most
promising for those use cases. If you're curious what those use cases are, the
types of problems recoil solves well are described in
