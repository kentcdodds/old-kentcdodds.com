...
keywords:
  ...
  - 'react query'
  - 'jotai'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625032132/kentcdodds.com/content/blog/application-state-management-with-react/banner.jpg'
bannerCredit: 'Photo by [Rene Böhmer](https://unsplash.com/photos/YeUVDKZWSZ4)'
---

Current Available Translations:

- [Russian](https://habr.com/ru/post/507572/)
- [Spanish](https://julianbetancourt.co/blog/manejo-de-estados-de-aplicacion-en-react)
- [Korean](https://im-developer.tistory.com/222)
- [Chinese](https://github.com/jinshuju/tech-blog/issues/4)
...
3. Bring in [jotai](https://github.com/pmndrs/jotai)
