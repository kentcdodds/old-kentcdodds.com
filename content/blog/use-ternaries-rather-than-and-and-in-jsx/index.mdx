---
slug: 'use-ternaries-rather-than-and-and-in-jsx'
title: 'Use ternaries rather than && in JSX'
date: '2020-07-27'
author: 'Kent C. Dodds'
description:
  '_What problems can happen when you use && to conditionally render content in
  JSX_'
categories:
  - 'react'
keywords:
...
![PayPal page with contacts](./images/contacts.png)

When a user came with no contacts, this is what they saw:

![PayPal page with 0 instead of contacts](./images/no-contacts.png)
...
Another benfit of using actual branching syntax is that test coverage tools can
detect and indicate when your tests are not covering the one of the branches.
