...
AngularJS. I made a lot of friends through that podcast. Good times.
...
[the prop-types package](https://www.npmjs.com/package/prop-types)). I also
started [First Timers Only](/blog/first-timers-only).
...
[JavaScript Air](https://javascriptair.com). That transition went really well
and I was able to expand the topics of my weekly shows.
...
Jose every few months for work.
...
I wrapped up [JavaScript Air](https://javascriptair.com) in 2016 as well. I
didn't transition it to anyone else this time because I had a hope in the back
of my mind that I would start it back up again (at this point I don't think
that'll happen though). It was a fantastic show and there are still some
episodes that are relevant today.
...
Conference call across the country
