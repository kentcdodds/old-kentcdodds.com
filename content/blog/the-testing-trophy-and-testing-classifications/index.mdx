---
slug: 'the-testing-trophy-and-testing-classifications'
title: 'The Testing Trophy and Testing Classifications'
date: '2021-06-03'
author: 'Kent C. Dodds'
description: '_How to interpret the testing trophy for optimal clarity_'
categories:
  - 'testing'
keywords:
  - 'testing'
  ...
  - 'end-to-end tests'
  - 'react'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/f_auto,q_auto,dpr_2.0/v1622744114/kentcdodds.com/blog/the-testing-trophy-and-testing-classifications/banner_b3ihjh.jpg'
...
[Martin Fowler](https://twitter.com/martinfowler) introduced
...
[test shapes](https://martinfowler.com/articles/2021-test-shapes.html), Martin
quotes [Kent Beck](https://twitter.com/kentbeck):

> “in the first morning of my training course I cover 24 different definitions
> of unit test”.

This is a sad state of affairs, but it is what it is. As an educator, I had to
choose something that would make the most sense for the people I'm educated.
Judging by the response from people who have implemented my recommendations my
...
terms is a futile endeavor.

[Justin Searls](https://twitter.com/searls) said it best when he said:
...
on where to focus testing efforts.
