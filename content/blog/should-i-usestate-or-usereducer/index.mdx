...
1. I used state updater callbacks in when calling the state updater functions so
   I could receive the current state as an argument. This meant that I didn't
...
**When your one element of your state relies on the value of another element of
your state: `useReducer`**
...
- **When it's just an independent element of state you're managing: `useState`**
- **When your one element of your state relies on the value of another element
  of your state: `useReducer`**
