...
author: 'Kent C. Dodds'
description:
  _Two built-in React hooks that handle state, which one should you use?_
categories: ['react']
...
**[Watch "When to useState instead of useReducer"](https://egghead.io/lessons/react-when-to-usestate-instead-of-usereducer?pl=kent-s-blog-posts-as-screencasts-eefa540c)**

https://egghead.io/lessons/react-when-to-usestate-instead-of-usereducer?pl=kent-s-blog-posts-as-screencasts-eefa540c

**[Watch "When to useReducer instead of useState"](https://egghead.io/lessons/egghead-when-to-usereducer-instead-of-usestate?pl=kent-s-blog-posts-as-screencasts-eefa540c)**
