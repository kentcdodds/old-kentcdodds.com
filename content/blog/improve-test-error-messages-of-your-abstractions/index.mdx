---
slug: 'improve-test-error-messages-of-your-abstractions'
title: 'Improve test error messages of your abstractions'
date: '2020-05-18'
author: 'Kent C. Dodds'
description:
  '_How to manipulate stack traces to get beautiful error messages with Jest and
  your test helper functions._'
categories:
  - 'testing'
keywords:
  - 'testing'
  ...
  - 'stack trace'
  - 'messages'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625032930/kentcdodds.com/content/blog/improve-test-error-messages-of-your-abstractions/banner.jpg'
...
> like the one above. As with everything, you should be applying
> [AHA Programming](/blog/aha-programming) (and
> [for testing](/blog/aha-testing)). This blog post is just useful for
> situations where the abstraction is clear and you want to include assertions
> in your abstraction.
