---
slug: 'stop-mocking-fetch'
title: 'Stop mocking fetch'
date: '2020-06-03'
author: 'Kent C. Dodds'
description:
  "_Why you shouldn't mock fetch or your API Client in your tests and what to do
  instead._"
categories:
  - 'testing'
keywords:
  ...
  - 'integration'
  - 'unit'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625033354/kentcdodds.com/content/blog/stop-mocking-fetch/banner.jpg'
bannerCredit:
...
[E2E tests](/blog/unit-vs-integration-vs-e2e-tests) to give you that confidence,
but wouldn't it be better to just call into the `client` and get that confidence
here at this lower level where you have a tighter feedback loop? If it's not
much more difficult then sure!
