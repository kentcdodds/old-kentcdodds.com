---
slug: 'array-reduce-vs-chaining-vs-for-loop'
title: 'Array reduce vs chaining vs for loop'
date: '2020-01-13'
author: 'Kent C. Dodds'
description: '_A comparison of different approaches to operating on an array_'
categories:
  - 'javascript'
keywords:
  - 'arrays'
...
https://egghead.io/lessons/javascript-array-reduce-vs-chaining-vs-for-loop?pl=kent-s-blog-posts-as-screencasts-eefa540c&af=5236ad
...
compare `reduce` and `loop`s and use the one that's faster (I personally don't
think either has an upper leg on being more understandable).

I'd be interested to hear what you think. Click the "Discuss on twitter" link
below and let me know. And feel free to share if that's something you're into.
