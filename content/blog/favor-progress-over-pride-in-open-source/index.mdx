...
contributors have put into the inferior solution. Continuing to work on (and
inviting the work of others) when an objectively superior solution could
reasonably be used instead is (frankly) selfish and prideful.

## Deprecation is a gift

The people who created emotion were actually actively contributors to glamorous.
...
I'm not sure how else to organize about some of these thoughts, but I need to
...
someone else legitimately has an objectively solution, you'd better find a way
to differentiate yourself fast or you'll be looking for a new problem to solve
