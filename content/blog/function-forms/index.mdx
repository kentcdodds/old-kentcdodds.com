...
author: 'Kent C. Dodds'
description:
  '_When I prefer to use function declarations instead of arrow functions_'
categories:
  - 'javascript'
keywords:
  ...
  - 'arrow functions'
  - 'hoisting'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625032732/kentcdodds.com/content/blog/function-forms/banner.jpg'
