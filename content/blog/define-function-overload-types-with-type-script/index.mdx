---
slug: 'define-function-overload-types-with-type-script'
title: 'Define function overload types with TypeScript'
date: '2021-01-12'
author: 'Kent C. Dodds'
description: '_Have your JS expressiveness and type it too._'
categories:
  - 'typescript'
keywords:
  - 'typescript'
  - 'javascript'
  - 'functions'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625032659/kentcdodds.com/content/blog/define-function-overload-types-with-type-script/banner.jpg'
bannerCredit:
