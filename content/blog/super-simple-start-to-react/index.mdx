---
slug: 'super-simple-start-to-react'
title: 'Super Simple Start to React'
date: '2020-04-24'
author: 'Kent C. Dodds'
description: '_The most simple React setup imaginable_'
categories:
  - 'react'
keywords:
  - 'abstraction'
...
![Ball of Rubber bands](./images/rubber-bands-ball.jpg)
...
<html>
  <body>
    ...
    <script src="https://unpkg.com/@babel/standalone@7.8.3/babel.js"></script>
    <script type="text/babel">
      ReactDOM.render(<div className="container">Hello World</div>, document.getElementById('root'))
    </script>
  </body>
</html>
```
...
![Rubber bands separated](./images/rubber-bands.jpg)
