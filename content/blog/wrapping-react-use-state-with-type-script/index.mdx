---
slug: 'wrapping-react-use-state-with-type-script'
title: 'Wrapping React.useState with TypeScript'
date: '2021-01-19'
author: 'Kent C. Dodds'
description:
  '_How to make a custom hook that wraps useState with TypeScript properly_'
categories:
  - 'react'
keywords:
  - 'typescript'
  ...
  - 'type casting'
  - 'tuples'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625033541/kentcdodds.com/content/blog/wrapping-react-use-state-with-type-script/banner.jpg'
