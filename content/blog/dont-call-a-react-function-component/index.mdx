---
slug: 'dont-call-a-react-function-component'
title: "Don't call a React function component"
date: '2019-12-08'
author: 'Kent C. Dodds'
description:
  '_The difference between React.createElement and calling a function component
  directly_'
categories:
  - 'react'
keywords:
...
https://egghead.io/lessons/egghead-fix-react-error-rendered-fewer-hooks-than-expected?pl=kent-s-blog-posts-as-screencasts-eefa540c&af=5236ad
...
> about that from my other blog post:
> [Understanding React's key prop](/blog/understanding-reacts-key-prop)
...
instance, because there is no `Counter` component instance. So it will "work," but
not the way you'd expect and it could behave in unexpected ways as you make
