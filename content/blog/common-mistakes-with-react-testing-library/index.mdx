---
slug: 'common-mistakes-with-react-testing-library'
title: 'Common mistakes with React Testing Library'
date: '2020-05-04'
author: 'Kent C. Dodds'
description:
  '_Some mistakes I frequently see people making with React Testing Library._'
categories:
  - 'testing'
keywords:
  - 'react'
  ...
  - 'dom testing library'
  - 'async'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625032606/kentcdodds.com/content/blog/common-mistakes-with-react-testing-library/banner.jpg'
bannerCredit: 'Photo by [Sarah Kilian](https://unsplash.com/photos/52jRtc2S_VE)'
---

Current Available Translations:

- [Brazilian Portuguese](https://giovanisleite.dev/erros-comuns-com-react-testing-library)
- [Korean](https://seongry.github.io/2021/06-20-common-mistakes-with-rty/)
...
document so you can see what's rendred and maybe why your query failed to find
