...
readers will read for the element _and_ it works even if your element has it's
...
## Not using eslint-plugin-testing-library

> Importance: medium

If you'd like to avoid several of these common mistakes, then
[the official ESLint plugin could help out a lot](https://github.com/testing-library/eslint-plugin-testing-library).
