...
date: '2021-03-23'
author: 'Kent C. Dodds'
description: '_How to work with them... and around them_'
categories:
  - 'javascript'
keywords:
  - 'closure'
...
## Comment from Jean Lazarou

For me the code you show is not a closure but a simple function call.

A closure version would look like:
...
The output of the above code is (from browse console)

```
raspberry debugger eval code:7:13
peach debugger eval code:7:13
```
And here we see that 'it works', because the `getLogger` function has a binding to the closure.
