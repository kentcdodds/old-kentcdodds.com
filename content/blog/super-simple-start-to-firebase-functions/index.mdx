---
slug: 'super-simple-start-to-firebase-functions'
title: 'Super simple start to Firebase functions'
date: '2020-11-12'
author: 'Kent C. Dodds'
description: '_The simplest getting started guide for Firebase Cloud functions_'
categories:
  - 'node'
keywords:
  - 'serverless'
...
![Firebase console showing an "Add project" button](./images/step-1-firebase-console.png)
...
![Let's start with a name for your project. Project name: My Awesome Firebase Thing. my-awesome-firebase-thin-33d3a. A unique identifier for your project](./images/step-1-2-firebase-name.png)
...
![Firebase console showing the setting page with the Project ID](./images/step-3-project-id.png)
...
![Terminal output from the firebase login command](./images/step-8-login.png)
...
![Emulator overview](./images/step-9-emulator-overview.png)

If you hit your serverless function in a browser you should see the output:

![Browser saying "Hello World!"](./images/step-9-fn-output.png)

And then your logs will show that the function was run:

![Function logs](./images/step-9-fn-logs.png)
...
![Usage and billing settings page](./images/step-11-usage-and-billing.png)

Then you'll click "Modify plan" and then "Select plan" under "Blaze Pay as you
go":

![Firebase billing plans](./images/step-11-firebase-billing-plans.png)
...
![Browser saying "Hello Bob Ross!"](./images/step-10-deployed-fn-output.png)
...
First, create a `.github/workflow/deploy.yml` file and put this in it:
...
![GitHub secrets UI adding the firebase token](./images/step-14-add-secret.png)
...
![Action output showing the deploy](./images/step-16-action-output.png)
