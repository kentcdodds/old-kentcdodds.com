...
keywords:
  ...
  - 'functions'
  - 'cloud'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625033387/kentcdodds.com/content/blog/super-simple-start-to-firebase-functions/banner.jpg'
