---
slug: 'listify-a-java-script-array'
title: 'Listify a JavaScript Array'
date: '2021-02-18'
author: 'Kent C. Dodds'
description: '_Make a human readable list from an array in JavaScript._'
categories:
  - 'javascript'
keywords:
  - 'javascript'
  ...
  - 'Intl'
  - 'Intl.FormatList'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625033090/kentcdodds.com/content/blog/listify-a-java-script-array/banner.jpg'
bannerCredit:
