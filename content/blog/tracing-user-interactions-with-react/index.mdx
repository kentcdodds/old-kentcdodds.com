---
slug: 'tracing-user-interactions-with-react'
title: 'Tracing user interactions with React'
date: '2020-05-08'
author: 'Kent C. Dodds'
description:
  '_How to use the (EXPERIMENTAL) interactions tracing API in React._'
categories:
  - 'react'
keywords:
  - 'react'
  ...
  - 'trace'
  - 'scheduler'
bannerUrl: 'https://res.cloudinary.com/kentcdodds-com/image/upload/v1625033451/kentcdodds.com/content/blog/tracing-user-interactions-with-react/banner.jpg'
...
> **Alert**: Please remember that this is an unstable/experimental API from
> React and may change when the feature is officially released.
