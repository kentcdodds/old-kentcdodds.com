---
slug: 'use-react-error-boundary-to-handle-errors-in-react'
title: 'Use react-error-boundary to handle errors in React'
date: '2020-07-20'
author: 'Kent C. Dodds'
description:
  '_How to simplify your React apps by handling React errors effectively with
  react-error-boundary_'
categories:
  - 'react'
keywords:
  - 'react'
...
import {TryCatchApp, BoundaryApp, RecoveryApp, Layout} from './components'
...
![Chrome window with nothing but white](./images/white-screen.png)

If you run this with create-react-app's error overlay (during development),
you'll get this:

![TypeError Cannot read property 'toUpperCase' of undefined](./images/error-overlay.png)
...
Unfortunately, this doesn't work. And that's because we're not the one's calling
...
You'll notice that if you type "bomb" it the `Bomb` component is replaced by the
...
> [the implementation](https://github.com/bvaughn/react-error-boundary/blob/3c9339753b7f2982255a786af06077b7d4999a7a/src/index.js#L71-L76)
