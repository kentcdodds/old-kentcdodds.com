---
slug: 'using-fetch-with-type-script'
title: 'Using fetch with TypeScript'
date: '2021-01-26'
author: 'Kent C. Dodds'
description: '_How to make HTTP requests with fetch and TypeScript_'
categories:
  - 'typescript'
keywords:
  - 'fetch'
...
bannerCredit:
  'Photo by [Anthony Duran](https://unsplash.com/photos/1Ck8CCXlVEU)'
---
...
adding types. When migrating this code to TypeScript, I ran into a few little
hurdles I want to share with you.
...
A quick review here though will show that both `data` and `errors` is `any`:
...
And that's it! We've no successfully typed `fetch` for a particular request. 🎉
