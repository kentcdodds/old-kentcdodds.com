...
<List>
  <Li check>know how Suspense works fundamentally</Li>
  <Li check>be able to write your own Suspense-based abstraction</Li>
  <Li check>understand the benefits and how to of "render as you fetch"</Li>
  <Li check>
    know how to use <code>useTransition</code> and <code>useDeferredValue</code>{' '}
    effectively
  </Li>
  <Li check>
